...
graph TD
    ...
    Nginx -->|Frontend Routes| NextJS[Next.js Frontend]
...
*   Initialize the Next.js frontend with Tailwind CSS.
...
-   Run Next.js build tests to ensure the frontend compiles without errors.

### Manual Verification
-   Deploy a sample Next.js/FastAPI application using the newly created platform.
